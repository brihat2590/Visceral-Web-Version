    ...
    <nav className="w-full max-w-[1440px] mx-auto px-6 md:px-[120px] py-4 h-[102px] flex items-center justify-between relative z-[50]">
      <div className="flex items-center gap-20">
        ...
        <div className="hidden md:flex items-center gap-2.5">
          <a href="#" className="px-2.5 py-1 text-[#cccccc] hover:text-white font-medium text-sm leading-[22px]" style={{ fontFamily: 'Manrope, sans-serif' }}>Home</a>
          <a href="#" className="px-2.5 py-1 font-medium text-sm leading-[22px] text-[#cccccc] hover:text-white" style={{ fontFamily: 'Manrope, sans-serif' }}>Contact us</a>
        </div>
      </div>

      {/* Desktop Buttons - Hidden on mobile */}
      <div className="hidden md:flex items-center gap-3">
        <button className="px-4 py-2 text-[#cccccc] rounded-lg font-semibold text-sm leading-[22px] hover:text-[#ffffff]" style={{ fontFamily: 'Manrope, sans-serif' }}>
          Login
        </button>
      ...
      {isOpen && (
        <div className="absolute top-[102px] left-0 w-full bg-[#0a0a0a] border-b border-white/10 flex flex-col p-6 gap-6 md:hidden z-50">
          ...
          <button className="text-[#cccccc] text-left font-medium">Login</button>
